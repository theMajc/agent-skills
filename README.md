...
| [`decompose`](skills/decompose/) | Fast, narratable ritual (entities → data flow → edge cases → interface contract) for structuring a verbal problem statement before code, with a generated Mermaid diagram and a conditional data-integration checklist. | [`skills/decompose`](skills/decompose/) |
